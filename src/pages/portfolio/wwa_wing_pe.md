...
また、拡張機能を活用したシステムとして、プログラミングの変数や条件分岐、グラフィック描画機能を提供する **WWAeval** が公開されました。
...
前者のプログラミングの変数や条件分岐は WWA Wing XE が担うことになりました。後者のグラフィック描画機能を担当する拡張機能があっても良いのではないかと思い、開発を始めました。
